...
<main class="m-5">
  <h1>La liste des autheurs </h1>
  <!-- float-end : pour positionner totalment a droite
      float-stard
  ...
  <tbody>
    ...
    <tr>  
      <td><?=$user->id?></td>
      <td><img src="../../asset/users.png;<?=$user->photos?>" class="img-fluid br-100 w50%" alt="users image"></td>
      <td><?=$user->nom?></td>
      <td><?=$user->prenom?></td>
